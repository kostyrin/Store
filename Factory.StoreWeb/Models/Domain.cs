...
namespace Factory.StoreWeb.Models
{
    public class Data
    {
        public IEnumerable<Navbar> navbarItems()
        {
            ...
            menu.Add(new Navbar { Id = 2, nameOption = "Покупатели", controller = "Shopper", action = "Index", imageClass = "fa fa-fw fa-bar-chart-o", estatus = true });
        ...
        public IEnumerable<User> users()
        {
            ...
            users.Add(new User { Id = 1, user = "ka@ipositron.ru", password = "12345", estatus = true, RememberMe = true });
